...
export function Orders() {
    ...
    function handleStatus(status) {
        if (status.id === 0) {
            ...
            const newdOrders = orders.filter(order => order.status === status.value);
            setFilteredOrders(newdOrders);
        }
    ...
    useEffect(() => {
        if (activeStatus === 0) {
            ...
            const newFilteredOrders = orders.filter(order => order.statu === orderStatusOptions[statusIndex].value);
